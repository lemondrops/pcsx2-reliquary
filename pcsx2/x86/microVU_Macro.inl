...
REC_COP2_mVU0_ADDSUB(ADD,    "ADD",    0x110);
REC_COP2_mVU0_ADDSUB(ADDi,   "ADDi",   0x110);
REC_COP2_mVU0_ADDSUB(ADDq,   "ADDq",   0x111);
REC_COP2_mVU0_ADDSUB(ADDx,   "ADDx",   0x110);
REC_COP2_mVU0_ADDSUB(ADDy,   "ADDy",   0x110);
REC_COP2_mVU0_ADDSUB(ADDz,   "ADDz",   0x110);
REC_COP2_mVU0_ADDSUB(ADDw,   "ADDw",   0x110);
REC_COP2_mVU0_ADDSUB(ADDA,   "ADDA",   0x110);
REC_COP2_mVU0_ADDSUB(ADDAi,  "ADDAi",  0x110);
REC_COP2_mVU0_ADDSUB(ADDAq,  "ADDAq",  0x111);
REC_COP2_mVU0_ADDSUB(ADDAx,  "ADDAx",  0x110);
REC_COP2_mVU0_ADDSUB(ADDAy,  "ADDAy",  0x110);
REC_COP2_mVU0_ADDSUB(ADDAz,  "ADDAz",  0x110);
REC_COP2_mVU0_ADDSUB(ADDAw,  "ADDAw",  0x110);
REC_COP2_mVU0_ADDSUB(SUB,    "SUB",    0x110);
REC_COP2_mVU0_ADDSUB(SUBi,   "SUBi",   0x110);
REC_COP2_mVU0_ADDSUB(SUBq,   "SUBq",   0x111);
REC_COP2_mVU0_ADDSUB(SUBx,   "SUBx",   0x110);
REC_COP2_mVU0_ADDSUB(SUBy,   "SUBy",   0x110);
REC_COP2_mVU0_ADDSUB(SUBz,   "SUBz",   0x110);
REC_COP2_mVU0_ADDSUB(SUBw,   "SUBw",   0x110);
REC_COP2_mVU0_ADDSUB(SUBA,   "SUBA",   0x110);
REC_COP2_mVU0_ADDSUB(SUBAi,  "SUBAi",  0x110);
REC_COP2_mVU0_ADDSUB(SUBAq,  "SUBAq",  0x111);
REC_COP2_mVU0_ADDSUB(SUBAx,  "SUBAx",  0x110);
REC_COP2_mVU0_ADDSUB(SUBAy,  "SUBAy",  0x110);
REC_COP2_mVU0_ADDSUB(SUBAz,  "SUBAz",  0x110);
REC_COP2_mVU0_ADDSUB(SUBAw,  "SUBAw",  0x110);
REC_COP2_mVU0_MUL(MUL,    "MUL",    0x110);
REC_COP2_mVU0_MUL(MULi,   "MULi",   0x110);
REC_COP2_mVU0_MUL(MULq,   "MULq",   0x111);
REC_COP2_mVU0_MUL(MULx,   "MULx",   0x110);
REC_COP2_mVU0_MUL(MULy,   "MULy",   0x110);
REC_COP2_mVU0_MUL(MULz,   "MULz",   0x110);
REC_COP2_mVU0_MUL(MULw,   "MULw",   0x110);
REC_COP2_mVU0_MUL(MULA,   "MULA",   0x110);
REC_COP2_mVU0_MUL(MULAi,  "MULAi",  0x110);
REC_COP2_mVU0_MUL(MULAq,  "MULAq",  0x111);
REC_COP2_mVU0_MUL(MULAx,  "MULAx",  0x110);
REC_COP2_mVU0_MUL(MULAy,  "MULAy",  0x110);
REC_COP2_mVU0_MUL(MULAz,  "MULAz",  0x110);
REC_COP2_mVU0_MUL(MULAw,  "MULAw",  0x110);
...
REC_COP2_mVU0_FMAC(MADDAx, "MADDAx", 0x110);
...
REC_COP2_mVU0_FMAC(MSUBAx, "MSUBAx", 0x110);
...
REC_COP2_mVU0_DIVSQRT(DIV,   "DIV",   0x112);
REC_COP2_mVU0_DIVSQRT(SQRT,  "SQRT",  0x112);
REC_COP2_mVU0_DIVSQRT(RSQRT, "RSQRT", 0x112);
